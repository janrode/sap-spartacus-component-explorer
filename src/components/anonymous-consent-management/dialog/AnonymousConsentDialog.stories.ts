...
import { AnonymousConsentDialogComponent, AnonymousConsentsDialogModule } from '@spartacus/storefront'
import { AnonymousConsentsServiceProvider } from '../AnonymousConsentsServiceProvider'
import { anonymousConsentsConfig, AnonymousConsentsConfigProvider } from '../AnonymousConsentsConfigProvider'
...
export default {
  ...
  decorators: [
    setupSpartacus(
      ...
      [AnonymousConsentsConfigProvider, AnonymousConsentsServiceProvider, LaunchDialogServiceProvider]
    ),
  ],
